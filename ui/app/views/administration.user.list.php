		...
		->addFilterTab(_('Filter'), [
			...
			(new CFormList())->addRow(_('User type'),
				(new CRadioButtonList('filter_type', (int) $data['filter']['type']))
					...
					->addValue(user_type2str(USER_TYPE_READ_ONLY), USER_TYPE_READ_ONLY)
					->addValue(user_type2str(USER_TYPE_POWER_USER), USER_TYPE_POWER_USER)
					->addValue(user_type2str(USER_TYPE_COMPLIANCE), USER_TYPE_COMPLIANCE)
					->setModern(true)
			)
		])
