...
#	define ZBX_CIPHERS_PSK		"PSK-AES128-CBC-SHA"
	...
	if (NULL != ctx_psk)
	{
...
#if OPENSSL_VERSION_NUMBER >= 0x1010100fL	/* OpenSSL 1.1.1 or newer */
		zabbix_log(LOG_LEVEL_INFORMATION, "TLS ciphersuites initializing");
		...
		zabbix_log(LOG_LEVEL_INFORMATION, "TLS ciphersuites initialized");
#else
		zabbix_log(LOG_LEVEL_INFORMATION, "TLS ciphersuites not initialized");
#endif
