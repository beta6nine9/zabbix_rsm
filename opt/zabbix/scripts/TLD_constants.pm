...
use constant ITEM_TYPE_DEPENDENT			=> 18;

use constant ZBX_PREPROC_JSONPATH			=> 12;
use constant ZBX_PREPROC_THROTTLE_TIMED_VALUE		=> 20;

use constant ZBX_PREPROC_FAIL_DISCARD_VALUE		=> 1;

use constant ZBX_PREPROC_THROTTLE_TIMED_VALUE_SECONDS	=> 3600;	# 1 hour
...
our @EXPORT_OK = qw(
	...
	ITEM_TYPE_ZABBIX ITEM_TYPE_TRAPPER ITEM_TYPE_SIMPLE ITEM_TYPE_INTERNAL ITEM_TYPE_ZABBIX_ACTIVE ITEM_TYPE_AGGREGATE ITEM_TYPE_EXTERNAL ITEM_TYPE_CALCULATED ITEM_TYPE_DEPENDENT
	ZBX_PREPROC_JSONPATH
	ZBX_PREPROC_THROTTLE_TIMED_VALUE
	ZBX_PREPROC_FAIL_DISCARD_VALUE
	ZBX_PREPROC_THROTTLE_TIMED_VALUE_SECONDS
